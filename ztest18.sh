...
echo '=== Test base emitter (passes disabled) with CG-IR-008 ==='
cp compiler_passes.c compiler_passes.c.bak_noopt6
...
cp compiler_passes.c.bak_noopt6 compiler_passes.c
echo 'Restored.'
echo DONE
