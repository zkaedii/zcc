...
__attribute__((visibility("internal"))) extern void luaT_getvarargs (lua_State *L, CallInfo *ci,
...
__attribute__((visibility("internal"))) extern int luaE_resetthread (lua_State *L, int status);
...
__attribute__((visibility("internal"))) extern void __attribute__((noreturn)) luaG_typeerror (lua_State *L, const TValue *o,
                                                const char *opname);
__attribute__((visibility("internal"))) extern void __attribute__((noreturn)) luaG_callerror (lua_State *L, const TValue *o);
...
__attribute__((visibility("internal"))) extern int luaD_pretailcall (lua_State *L, CallInfo *ci, StkId func,
                                              int narg1, int delta);
__attribute__((visibility("internal"))) extern CallInfo *luaD_precall (lua_State *L, StkId func, int nResults);
...
__attribute__((visibility("internal"))) extern StkId luaD_tryfuncTM (lua_State *L, StkId func);
__attribute__((visibility("internal"))) extern int luaD_closeprotected (lua_State *L, ptrdiff_t level, int status);
...
__attribute__((visibility("internal"))) extern CClosure *luaF_newCclosure (lua_State *L, int nupvals);
__attribute__((visibility("internal"))) extern LClosure *luaF_newLclosure (lua_State *L, int nupvals);
...
__attribute__((visibility("internal"))) extern void luaF_closeupval (lua_State *L, StkId level);
__attribute__((visibility("internal"))) extern StkId luaF_close (lua_State *L, StkId level, int status, int yy);
...
__attribute__((visibility("internal"))) extern GCObject *luaC_newobjdt (lua_State *L, int tt, size_t sz,
                                                 size_t offset);
...
__attribute__((visibility("internal"))) extern void luaH_newkey (lua_State *L, Table *t, const TValue *key,
                                                    TValue *value);
__attribute__((visibility("internal"))) extern void luaH_set (lua_State *L, Table *t, const TValue *key,
                                                 TValue *value);
__attribute__((visibility("internal"))) extern void luaH_finishset (lua_State *L, Table *t, const TValue *key,
...
__attribute__((visibility("internal"))) extern int luaV_tointeger (const TValue *obj, lua_Integer *p, F2Imod mode);
__attribute__((visibility("internal"))) extern int luaV_tointegerns (const TValue *obj, lua_Integer *p,
                                F2Imod mode);
__attribute__((visibility("internal"))) extern int luaV_flttointeger (lua_Number n, lua_Integer *p, F2Imod mode);
...
extern lua_Integer lua_tointegerx (lua_State *L, int idx, int *pisnum) {
  lua_Integer res = 0;
  const TValue *o = index2value(L, idx);
  int isnum = ((__builtin_expect(((((((o))->tt_) == (((3) | ((0) << 4))))) != 0), 1)) ? (*(&res) = (((o)->value_).i), 1) : luaV_tointeger(o,&res,F2Ieq));
  if (pisnum)
    *pisnum = isnum;
  return res;
}
...
StkId luaD_tryfuncTM (lua_State *L, StkId func) {
  const TValue *tm;
  StkId p;
  if ((__builtin_expect(((L->stack_last.p - L->top.p <= (1)) != 0), 0))) { ptrdiff_t t__ = (((char *)((func))) - ((char *)((L->stack.p)))); { if ((L->l_G)->GCdebt > 0) { (void)0; luaC_step(L); (void)0;}; ((void)0); }; luaD_growstack(L, 1, 1); func = ((StkId)(((char *)((L->stack.p))) + (t__))); } else { ((void)0); };
...
void luaD_poscall (lua_State *L, CallInfo *ci, int nres) {
  ...
  if ((__builtin_expect(((L->hookmask && !((wanted) < (-1))) != 0), 0)))
    rethook(L, ci, nres);
...
static inline int precallC (lua_State *L, StkId func, int nresults,
  ...
  int n;
  CallInfo *ci;
  if ((__builtin_expect(((L->stack_last.p - L->top.p <= (20)) != 0), 0))) { ptrdiff_t t__ = (((char *)((func))) - ((char *)((L->stack.p)))); { if ((L->l_G)->GCdebt > 0) { (void)0; luaC_step(L); (void)0;}; ((void)0); }; luaD_growstack(L, 20, 1); func = ((StkId)(((char *)((L->stack.p))) + (t__))); } else { ((void)0); };
 ...
 retry:
  switch ((((((&(func)->val))->tt_)) & 0x3F)) {
    ...
    case ((6) | ((0) << 4)): {
      ...
      int i;
      if ((__builtin_expect(((L->stack_last.p - L->top.p <= (fsize - delta)) != 0), 0))) { ptrdiff_t t__ = (((char *)((func))) - ((char *)((L->stack.p)))); { if ((L->l_G)->GCdebt > 0) { (void)0; luaC_step(L); (void)0;}; ((void)0); }; luaD_growstack(L, fsize - delta, 1); func = ((StkId)(((char *)((L->stack.p))) + (t__))); } else { ((void)0); };
      ci->func.p -= delta;
      for (i = 0; i < narg1; i++)
 ...
 retry:
  switch ((((((&(func)->val))->tt_)) & 0x3F)) {
    ...
    case ((6) | ((0) << 4)): {
      ...
      int nfixparams = p->numparams;
      int fsize = p->maxstacksize;
      if ((__builtin_expect(((L->stack_last.p - L->top.p <= (fsize)) != 0), 0))) { ptrdiff_t t__ = (((char *)((func))) - ((char *)((L->stack.p)))); { if ((L->l_G)->GCdebt > 0) { (void)0; luaC_step(L); (void)0;}; ((void)0); }; luaD_growstack(L, fsize, 1); func = ((StkId)(((char *)((L->stack.p))) + (t__))); } else { ((void)0); };
...
int luaO_rawarith (lua_State *L, int op, const TValue *p1, const TValue *p2,
  ...
  switch (op) {
    ...
    case 13: {
      ...
      if (((__builtin_expect(((((((p1))->tt_) == (((3) | ((0) << 4))))) != 0), 1)) ? (*(&i1) = (((p1)->value_).i), 1) : luaV_tointegerns(p1,&i1,F2Ieq)) && ((__builtin_expect(((((((p2))->tt_) == (((3) | ((0) << 4))))) != 0), 1)) ? (*(&i2) = (((p2)->value_).i), 1) : luaV_tointegerns(p2,&i2,F2Ieq))) {
...
static void growstrtab (lua_State *L, stringtable *tb) {
  if ((__builtin_expect(((tb->nuse == 0x7fffffff
     ) != 0), 0))) {
    luaC_fullgc(L, 1);
...
TString *luaS_newlstr (lua_State *L, const char *str, size_t l) {
  if (l <= 40)
    ...
    TString *ts;
    if ((__builtin_expect(((l >= ((sizeof(size_t) < sizeof(lua_Integer) ? ((size_t)(~(size_t)0)) : (size_t)(0x7fffffffffffffffLL
       )) - sizeof(TString))/sizeof(char)) != 0), 0)))
      luaM_toobig(L);
...
Udata *luaS_newudata (lua_State *L, size_t s, int nuvalue) {
  ...
  int i;
  GCObject *o;
  if ((__builtin_expect(((s > (sizeof(size_t) < sizeof(lua_Integer) ? ((size_t)(~(size_t)0)) : (size_t)(0x7fffffffffffffffLL
     )) - ((nuvalue) == 0 ? 
     __builtin_offsetof (
     Udata0
     , 
...
static void rehash (lua_State *L, Table *t, const TValue *ek) {
  unsigned int asize;
  unsigned int na;
  unsigned int nums[((int)((sizeof(int) * 8 
                   - 1))) + 1];
  int i;
  int totaluse;
...
void luaT_trybinTM (lua_State *L, const TValue *p1, const TValue *p2,
                    StkId res, TMS event) {
  if ((__builtin_expect(((!callbinTM(L, p1, p2, res, event)) != 0), 0))) {
    switch (event) {
...
void luaT_tryconcatTM (lua_State *L) {
  StkId top = L->top.p;
  if ((__builtin_expect(((!callbinTM(L, (&(top - 2)->val), (&(top - 1)->val), top - 2, TM_CONCAT)) != 0), 0))
                                          )
...
void luaT_getvarargs (lua_State *L, CallInfo *ci, StkId where, int wanted) {
  ...
  if (wanted < 0) {
    wanted = nextra;
    if ((__builtin_expect(((L->stack_last.p - L->top.p <= (nextra)) != 0), 0))) { ptrdiff_t t__ = (((char *)((where))) - ((char *)((L->stack.p)))); { if ((L->l_G)->GCdebt > 0) { (void)0; luaC_step(L); (void)0;}; ((void)0); }; luaD_growstack(L, nextra, 1); where = ((StkId)(((char *)((L->stack.p))) + (t__))); } else { ((void)0); };
...
extern void *luaL_checkudata (lua_State *L, int ud, const char *tname) {
  ...
  ((void)((__builtin_expect(((p != 
 ((void *)0)
 ) != 0), 1)) || luaL_typeerror(L, (ud), (tname))));
  return p;
}
extern int luaL_checkoption (lua_State *L, int arg, const char *def,
                                 const char *const lst[]) {
...
static size_t newbuffsize (luaL_Buffer *B, size_t sz) {
  ...
  if ((__builtin_expect(((((size_t)(~(size_t)0)) - sz < B->n) != 0), 0)))
...
static int luaB_dofile (lua_State *L) {
  ...
  lua_settop(L, 1);
  if ((__builtin_expect(((luaL_loadfilex(L,fname,
     ((void *)0)
     ) != 0) != 0), 0)))
    return lua_error(L);
...
static void *checkupval (lua_State *L, int argf, int argnup, int *pnup) {
  ...
  if (pnup) {
    ((void)((__builtin_expect(((id != 
   ((void *)0)
   ) != 0), 1)) || luaL_argerror(L, (argnup), ("invalid upvalue index"))));
    *pnup = nup;
  }
  return id;
}
...
static void findloader (lua_State *L, const char *name) {
  ...
  if ((__builtin_expect(((lua_getfield(L, ((-1000000 - 1000) - (1)), "searchers") != 5) != 0), 0))
                               )
...
static int str_rep (lua_State *L) {
  ...
  if (n <= 0)
    lua_pushstring(L, "" "");
  else if ((__builtin_expect(((l + lsep < l || l + lsep > (sizeof(size_t) < sizeof(int) ? ((size_t)(~(size_t)0)) : (size_t)(0x7fffffff
          )) / n) != 0), 0)))
...
static int str_byte (lua_State *L) {
  ...
  if ((__builtin_expect(((pose - posi >= (size_t)0x7fffffff
     ) != 0), 0)))
...
static int str_char (lua_State *L) {
  ...
  for (i=1; i<=n; i++) {
    ...
    ((void)((__builtin_expect(((c <= (lua_Unsigned)
   (0x7f * 2 + 1)
   ) != 0), 1)) || luaL_argerror(L, (i), ("value out of range"))));
...
static int str_dump (lua_State *L) {
  ...
  lua_settop(L, 1);
  state.init = 0;
  if ((__builtin_expect(((lua_dump(L, writer, &state, strip) != 0) != 0), 0)))
...
static void trymt (lua_State *L, const char *mtname) {
  lua_settop(L, 2);
  if ((__builtin_expect(((lua_type(L, 2) == 4 || !luaL_getmetafield(L, 2, mtname)) != 0), 0))
                                                  )
...
static int getnumlimit (Header *h, const char **fmt, int df) {
  ...
  if ((__builtin_expect(((sz > 16 || sz <= 0) != 0), 0)))
...
static KOption getoption (Header *h, const char **fmt, int *size) {
  ...
  *size = 0;
  switch (opt) {
    ...
    case 'c':
      *size = getnum(fmt, -1);
      if ((__builtin_expect(((*size == -1) != 0), 0)))
  ...
  while (*fmt != '\0') {
    ...
    switch (opt) {
      ...
      case Kuint: {
        lua_Integer n = luaL_checkinteger(L, arg);
        if (size < ((int)sizeof(lua_Integer)))
          ((void)((__builtin_expect((((lua_Unsigned)n < ((lua_Unsigned)1 << (size * 8
         ))) != 0), 1)) || luaL_argerror(L, (arg), ("unsigned overflow"))))
                                                    ;
      ...
      case Kchar: {
        ...
        ((void)((__builtin_expect(((len <= (size_t)size) != 0), 1)) || luaL_argerror(L, (arg), ("string longer than given size"))))
                                                         ;
      ...
      case Kstring: {
        size_t len;
        const char *s = luaL_checklstring(L, arg, &len);
        ((void)((__builtin_expect(((size >= (int)sizeof(size_t) || len < ((size_t)1 << (size * 8
       ))) != 0), 1)) || luaL_argerror(L, (arg), ("string length does not fit in given size"))))
...
static int str_packsize (lua_State *L) {
  ...
  while (*fmt != '\0') {
    ...
    ((void)((__builtin_expect(((opt != Kstring && opt != Kzstr) != 0), 1)) || luaL_argerror(L, (1), ("variable-length format"))))
                                              ;
    size += ntoalign;
    ((void)((__builtin_expect(((totalsize <= (sizeof(size_t) < sizeof(int) ? ((size_t)(~(size_t)0)) : (size_t)(0x7fffffff
   )) - size) != 0), 1)) || luaL_argerror(L, (1), ("format result too large"))))
                                               ;
    totalsize += size;
  }
...
static int str_unpack (lua_State *L) {
  ...
  while (*fmt != '\0') {
    ...
    ((void)((__builtin_expect((((size_t)ntoalign + size <= ld - pos) != 0), 1)) || luaL_argerror(L, (2), ("data string too short"))))
                                            ;
    pos += ntoalign;
...
static int tmove (lua_State *L) {
  ...
  if (e >= f) {
    lua_Integer n, i;
    ((void)((__builtin_expect(((f > 0 || e < 0x7fffffffffffffffLL 
   + f) != 0), 1)) || luaL_argerror(L, (3), ("too many elements to move"))))
                                              ;
    n = e - f + 1;
    ((void)((__builtin_expect(((t <= 0x7fffffffffffffffLL 
   - n + 1) != 0), 1)) || luaL_argerror(L, (4), ("destination wrap around"))))
                                            ;
...
static int tunpack (lua_State *L) {
  ...
  if (i > e) return 0;
  n = (lua_Unsigned)e - i;
  if ((__builtin_expect(((n >= (unsigned int)0x7fffffff 
     || !lua_checkstack(L, (int)(++n))) != 0), 0))
                                                )
...
static int sort (lua_State *L) {
  ...
  if (n > 1) {
    ((void)((__builtin_expect(((n < 0x7fffffff
   ) != 0), 1)) || luaL_argerror(L, (1), ("array too big"))));
    if (!(lua_type(L, (2)) <= 0))
      luaL_checktype(L, 2, 6);
    lua_settop(L, 2);
